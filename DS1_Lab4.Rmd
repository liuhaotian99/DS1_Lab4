...
The appropriate number of clusters for the iris data set is 3 clusters. As evident in the figure above, the "kink" occurs at a cluster size of 3 for the curve hence that being the appropriate cluster size to use.
